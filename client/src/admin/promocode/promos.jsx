...
const PromoCode = () => {
    ...
    const handleDelete = (id) => {
        axios({
            method: 'delete',
            url: `${process.env.REACT_APP_API_BASE_URL}/api/admin/deletePromo/${id}`,
        }).then((res) => {
            setPromos((prev) => prev.filter((promo) => promo.promo_id != id))
        }).catch((err) => {
            console.log(err.response.data.message)
        });
    }
        ...
        <div className='p-4 ml-64 h-screen'>
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div className='flex justify-start my-2'>
                    <p onClick={() => setPopup(true)} className=' cursor-pointer mr-10 px-10 py-2 rounded-md text-white bg-[#6bbe9e]'>New</p>
                </div>
                    ...
                    <tbody>
                        {
                            promos?.map((promo, i) =>
                                <tr key={i} className="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 ">
                                        <a onClick={() => handleDelete(promo.promo_id)} className="cursor-pointer font-medium text-[#6bbe9e] hover:underline">Delete</a>
                                    </td>
                                </tr>
                            ).reverse()
                        }
                                ...
                                <div className="py-6 px-6 lg:px-8">
                                    ...
                                    <div>
                                        ...
                                        <button
                                            ...
                                            className={`w-full text-white ${false ? "bg-gray-500" : "bg-[#53a787]"}  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center`}
                                        >
                                            Save
                                        </button>
