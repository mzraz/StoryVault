...
const ChapterQues = () => {
  ...
  useEffect(() => {
    axios({
      ...
      .then((res) => {
        console.log("res.data.data.data- chapters---", res.data);
  ...
  const handleAdd = () => {
    axios({
      ...
      .catch((err) => {
        ...
        console.log("error createChapter---", err);
      });
  };
  ...
  const Chapter = ({ chapter, setChapters, i }) => {
    ...
    const handleDelete = () => {
      axios({
        method: "delete",
        url: `${process.env.REACT_APP_API_BASE_URL}/api/admin/deleteChapter/${chapter.chapterId}`,
      })
        .then((res) => {
          setChapters((prev) =>
            prev.filter((prevCh) => prevCh.chapterId != chapter.chapterId)
          );
    ...
    const handleUpdate = () => {
      ...
      axios({
        ...
        .catch((err) => {
          console.log("err while update chap---", err);
        });
    };
