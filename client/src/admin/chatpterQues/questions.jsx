...
const Questions = () => {
  ...
  useEffect(() => {
    axios({
      ...
      .then((res) => {
        console.log("res.data.data.data- questions---", res.data);
  ...
  const Question = ({ question, i }) => {
    ...
    const handleDelete = () => {
      axios({
        method: "delete",
        url: `${process.env.REACT_APP_API_BASE_URL}/api/admin/deleteQuestion/${question.questionId}`,
      })
        .then((res) => {
          setQuestions((prev) =>
            prev.filter((prevQue) => prevQue.questionId != question.questionId)
          );
    ...
    const handleUpdate = () => {
      ...
      axios({
        ...
        .catch((err) => {
          console.log("err while update ques---", err);
        });
    };
