...
const Gifts = () => {
    ...
    const handleDelete = (id) => {
        axios({
            method: 'delete',
            url: `${process.env.REACT_APP_API_BASE_URL}/api/admin/deleteGift/${id}`,
        }).then((res) => {
                    ...
                    <tbody>
                        {
                            vouchers.map((voucher, i) =>
                                <tr key={i} className="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 ">
                                        <a onClick={() => handleDelete(voucher.voucher_id)} className="cursor-pointer font-medium text-[#6bbe9e] hover:underline">Delete</a>
                                    </td>
                                </tr>
                            ).reverse()
                        }
